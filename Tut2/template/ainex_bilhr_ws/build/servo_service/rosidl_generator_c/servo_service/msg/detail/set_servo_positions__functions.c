...
servo_service__msg__SetServoPositions__init(servo_service__msg__SetServoPositions * msg)
{
  ...
  if (!rosidl_runtime_c__uint8__Sequence__init(&msg->ids, 0)) {
    servo_service__msg__SetServoPositions__fini(msg);
    return false;
  }
  // positions
...
servo_service__msg__SetServoPositions__create(void)
{
  ...
  servo_service__msg__SetServoPositions * msg = (servo_service__msg__SetServoPositions *)allocator.allocate(sizeof(servo_service__msg__SetServoPositions), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(servo_service__msg__SetServoPositions));
  bool success = servo_service__msg__SetServoPositions__init(msg);
  if (!success) {
...
servo_service__msg__SetServoPositions__Sequence__init(servo_service__msg__SetServoPositions__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  servo_service__msg__SetServoPositions * data = NULL;

  if (size) {
    data = (servo_service__msg__SetServoPositions *)allocator.zero_allocate(size, sizeof(servo_service__msg__SetServoPositions), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = servo_service__msg__SetServoPositions__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        servo_service__msg__SetServoPositions__fini(&data[i - 1]);
      }
...
servo_service__msg__SetServoPositions__Sequence__fini(servo_service__msg__SetServoPositions__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      servo_service__msg__SetServoPositions__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  servo_service__msg__SetServoPositions__Sequence * array = (servo_service__msg__SetServoPositions__Sequence *)allocator.allocate(sizeof(servo_service__msg__SetServoPositions__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = servo_service__msg__SetServoPositions__Sequence__init(array, size);
  if (!success) {
...
servo_service__msg__SetServoPositions__Sequence__destroy(servo_service__msg__SetServoPositions__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    servo_service__msg__SetServoPositions__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
servo_service__msg__SetServoPositions__Sequence__are_equal(const servo_service__msg__SetServoPositions__Sequence * lhs, const servo_service__msg__SetServoPositions__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!servo_service__msg__SetServoPositions__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  servo_service__msg__SetServoPositions__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(servo_service__msg__SetServoPositions);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    servo_service__msg__SetServoPositions * data =
      (servo_service__msg__SetServoPositions *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!servo_service__msg__SetServoPositions__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          servo_service__msg__SetServoPositions__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!servo_service__msg__SetServoPositions__copy(
