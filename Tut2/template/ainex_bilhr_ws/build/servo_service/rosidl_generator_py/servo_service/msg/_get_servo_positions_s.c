...
bool servo_service__msg__get_servo_positions__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("servo_service.msg._get_servo_positions.GetServoPositions", full_classname_dest, 56) == 0);
  }
  servo_service__msg__GetServoPositions * ros_message = _ros_message;
  {  // ids
...
{
  /* NOTE(esteve): Call constructor of GetServoPositions */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("servo_service.msg._get_servo_positions");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetServoPositions");
