...
#include "servo_service/msg/detail/change_servo_positions__rosidl_typesupport_fastrtps_c.h"
...
using _ChangeServoPositions__ros_msg_type = servo_service__msg__ChangeServoPositions;
...
{
  const _ChangeServoPositions__ros_msg_type * ros_message = static_cast<const _ChangeServoPositions__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_service__msg__ChangeServoPositions;
    is_plain =
      (
...
static bool _ChangeServoPositions__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const servo_service__msg__ChangeServoPositions * ros_message = static_cast<const servo_service__msg__ChangeServoPositions *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_servo_service__msg__ChangeServoPositions(ros_message, cdr);
}

static bool _ChangeServoPositions__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  servo_service__msg__ChangeServoPositions * ros_message = static_cast<servo_service__msg__ChangeServoPositions *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_servo_service__msg__ChangeServoPositions(cdr, ros_message);
}

static uint32_t _ChangeServoPositions__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_servo_service__msg__ChangeServoPositions(
      untyped_ros_message, 0));
}

static size_t _ChangeServoPositions__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_servo_service__msg__ChangeServoPositions(
...
static message_type_support_callbacks_t __callbacks_ChangeServoPositions = {
  "servo_service::msg",
  "ChangeServoPositions",
  _ChangeServoPositions__cdr_serialize,
  _ChangeServoPositions__cdr_deserialize,
  _ChangeServoPositions__get_serialized_size,
  _ChangeServoPositions__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _ChangeServoPositions__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ChangeServoPositions,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, servo_service, msg, ChangeServoPositions)() {
  return &_ChangeServoPositions__type_support;
}
