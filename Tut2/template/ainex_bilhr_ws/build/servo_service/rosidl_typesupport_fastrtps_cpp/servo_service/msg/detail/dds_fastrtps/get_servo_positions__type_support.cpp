...
#include "servo_service/msg/detail/get_servo_positions__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const servo_service::msg::GetServoPositions & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  servo_service::msg::GetServoPositions & ros_message)
{
  // Member: ids
  {
    cdr >> ros_message.ids;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_servo_service
max_serialized_size_GetServoPositions(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_service::msg::GetServoPositions;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_servo_service
max_serialized_size_key_GetServoPositions(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const servo_service::msg::GetServoPositions *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<servo_service::msg::GetServoPositions *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetServoPositions__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const servo_service::msg::GetServoPositions *>(
...
static size_t _GetServoPositions__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetServoPositions(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetServoPositions__callbacks = {
  "servo_service::msg",
  "GetServoPositions",
...
static rosidl_message_type_support_t _GetServoPositions__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetServoPositions__callbacks,
...
{
  return &servo_service::msg::typesupport_fastrtps_cpp::_GetServoPositions__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servo_service, msg, GetServoPositions)() {
  return &servo_service::msg::typesupport_fastrtps_cpp::_GetServoPositions__handle;
}
