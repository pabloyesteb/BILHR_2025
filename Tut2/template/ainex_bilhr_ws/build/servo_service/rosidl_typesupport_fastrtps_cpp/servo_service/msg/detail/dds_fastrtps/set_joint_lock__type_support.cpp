...
#include "servo_service/msg/detail/set_joint_lock__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_service::msg::SetJointLock;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const servo_service::msg::SetJointLock *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<servo_service::msg::SetJointLock *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetJointLock__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const servo_service::msg::SetJointLock *>(
...
static size_t _SetJointLock__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetJointLock(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetJointLock__callbacks = {
  "servo_service::msg",
  "SetJointLock",
...
static rosidl_message_type_support_t _SetJointLock__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetJointLock__callbacks,
...
{
  return &servo_service::msg::typesupport_fastrtps_cpp::_SetJointLock__handle;
}
